...
internal object LlamaRuntimeIpc {
    ...
    const val EXTRA_KV_METHOD = "kv_method"
    const val EXTRA_KV_METHOD_PRESET = "kv_method_preset"
    ...
    const val EXTRA_RESULT_REQUESTED_KV_METHOD = "result_requested_kv_method"
    const val EXTRA_RESULT_EFFECTIVE_KV_METHOD = "result_effective_kv_method"
    const val EXTRA_RESULT_KV_METHOD_PRESET = "result_kv_method_preset"
    const val EXTRA_RESULT_KV_METHOD_DEMOTION_REASON = "result_kv_method_demotion_reason"
