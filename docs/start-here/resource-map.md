...
- PRD and MVP contract: `docs/prd/phase-0-prd.md`
- Implemented UX behavior truth: `docs/ux/implemented-behavior-reference.md`
- Model setup and readiness flow: `docs/ux/model-management-flow.md`
- User journey and recovery requirements: `docs/ux/user-journey-map.md`, `docs/ux/ux-12-recovery-journey-spec.md`
