...
| P-03 | Diagnostics are privacy-safe by default | Diagnostics redaction checks + UX copy | `docs/operations/evidence/index.md` (WP-04 summary), `docs/ux/implemented-behavior-reference.md` | Verified |
