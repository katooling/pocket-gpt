...
Define and validate messaging, category positioning, and launch channel strategy grounded in what the product can reliably deliver.

## Where To Start

1. Check `docs/operations/execution-board.md` for technical readiness.
2. Align messaging with validated capabilities only.
3. Keep launch assets synced with product/QA evidence.
...
1. All claims map to validated product behavior.
2. Differentiation is clear and defensible.
3. Launch materials reflect current MVP scope.
4. Distribution plan has measurable experiments and success metrics.
